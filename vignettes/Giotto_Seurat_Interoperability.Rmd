...
Here we demonstrates how to extract the top features and visualize them using SpatialFeaturePlot. We arrange the features in a grid with 3 columns and adjust the transparency for improved visualization.

```{r message=FALSE, warning=FALSE}
top.features <- head(SpatiallyVariableFeatures(brain2, selection.method = "moransi"), 6)
SpatialFeaturePlot(brain2, features = top.features, ncol = 3, alpha = c(0.1, 1))
```
