...
#' @param include_image_in_border logical. expand the extent sampled to also show image in
...
#' @param flex_resample logical. Whether to allow automatic selection of sampling
...
find_terra_writeRaster_dataType <- function(giottoLargeImage = NULL,
  ...
  dataTypeVerbose <- data.frame(
    ...
    dataTypeChoices = c("INT1U", "INT2U", "INT2S", "INT4U", "INT4S", "FLT4S", "FLT8S"),
    dataTypeVerbose = c(
      "8bit unsigned integer", "16bit unsigned integer", "16bit signed integer",
