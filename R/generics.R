...
# Object creation ####
setGeneric("createGiottoPoints", 
            function(x, ...) standardGeneric("createGiottoPoints"))
setGeneric("createGiottoPolygon", 
...
# copy() S4 generic ####
setGeneric("copy", 
        function(x) standardGeneric("copy"), useAsDefault = data.table::copy)


# spatial operations ####
setGeneric("calculateOverlap", 
            function(x, y, ...) standardGeneric("calculateOverlap"))
setGeneric("overlapToMatrix", 
