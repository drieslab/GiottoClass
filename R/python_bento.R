...
createBentoAdata <- function(gobject = NULL,
    ...
    coordinates_df <- lapply(
        transcripts_df["geometry"], sf::st_coordinates)$geometry
    ...
    bento_adata <- create_AnnData(transcripts = t_df, cell_shape = cell_poly, 
